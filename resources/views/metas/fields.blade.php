...
<!-- Keyword Field -->
<div class="form-group col-sm-6">
    {!! Form::label('keyword', 'Keyword:', ['class' => 'd-block']) !!}
    {!! Form::text('keyword', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-6">
    <label for="page_id">For Page:</label>
    <select name="page_id" class="form-control">
        @foreach($contentTypesEnum::cases() as $pageType)
            <option value={{$pageType->value}}>{{$pageType->title()}}</option>
        @endforeach
    </select>
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('metas.index') !!}" class="btn btn-light">Cancel</a>
</div>
