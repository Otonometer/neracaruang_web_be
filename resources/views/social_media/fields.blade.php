<div class="row">
    ...
    <!-- Image Field -->
    <div class="form-group col-sm-6">
        {!! Form::label('image', 'Image Blue:', ['class' => 'd-block']) !!}
        {!! Form::file('image', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$socialMedia->image ? asset($socialMedia->image) : '', 'data-allowed-file-extensions' => 'jpg jpeg png svg', 'data-max-file-size' => '1M']) !!}
    </div>

    <!-- Image Green Field -->
    <div class="form-group col-sm-6">
        {!! Form::label('image_green', 'Image Green:', ['class' => 'd-block']) !!}
        {!! Form::file('image_green', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$socialMedia->image_green ? asset($socialMedia->image_green) : '', 'data-allowed-file-extensions' => 'jpg jpeg png svg', 'data-max-file-size' => '1M']) !!}
    </div>
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('socialMedia.index') !!}" class="btn btn-light">Cancel</a>
</div>
