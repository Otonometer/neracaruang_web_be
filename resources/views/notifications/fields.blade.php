<div class="row">
    ...
    <div class="form-group col-sm-6">
        {!! Form::label('type', 'Header:', ['class' => 'd-block']) !!}
    ...
    <div class="form-group col-sm-12">
        ...
        {!! Form::file('image_uri', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$notification->image_uri ? asset($notification->image_uri) : '', 'data-allowed-file-extensions' => 'jpg jpeg png svg', 'data-max-file-size' => '1M', !isset($notification) ? 'required' : '']) !!}
    </div>
    ...
    <div class="form-group col-sm-9">
        {!! Form::label('link_uri', 'Url:', ['class' => 'd-block']) !!}
        {!! Form::text('link_uri', null, ['class' => 'form-control']) !!}
    </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('notification.index') !!}" class="btn btn-light">Cancel</a>
</div>
