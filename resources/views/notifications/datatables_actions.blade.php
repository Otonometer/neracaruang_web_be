...
<div class='btn-group'>
    @can('notification-show')
        <a href="{{ route('notification.show', $id) }}" class='btn btn-outline-secondary btn-xs btn-icon'>
            <i class="fa fa-eye"></i>
        </a>
    @endcan
    @can('notification-edit')
        <a href="{{ route('notification.edit', $id) }}" class='btn btn-outline-primary btn-xs btn-icon'>
