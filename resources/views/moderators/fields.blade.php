<div class="row">
    <div class="col-sm-8">
        ...
        <div class="form-group col-sm-6">
            ...
            {!! Form::file('image', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$user->image ? asset($user->image) : '', 'data-allowed-file-extensions' => 'jpg jpeg png', 'data-max-file-size' => '3M']) !!}
        </div>
    </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('moderators.index') !!}" class="btn btn-light">Cancel</a>
</div>
