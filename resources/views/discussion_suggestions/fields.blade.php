<div class="row">
    ...
    <div class="form-group col-sm-6">
        {!! Form::label('topic', 'Topic:', ['class' => 'd-block']) !!}
        {!! Form::text('topic', null, ['class' => 'form-control']) !!}
    </div>

    <!-- Abstract Field -->
    <div class="form-group col-sm-12">
        {!! Form::label('abstract', 'Abstract:', ['class' => 'd-block']) !!}
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::select('user_id', @$user ?? [],null, ['class' => 'form-control select2']) !!}
    </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('discussionSuggestions.index') !!}" class="btn btn-light">Cancel</a>
</div>
...
<script>
    $(document).ready(function() {
        ...
        // $.ajax({
        //     type: 'POST',
        //     url: '{{url("api/discussion/comment/1")}}',
        //     data: {message : 'Hello, This is my first real time message'},
        //     headers: {
