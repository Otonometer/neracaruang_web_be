...
<div class="form-group col-sm-6">
    {!! Form::label('province_code', 'Province Code:', ['class' => 'd-block']) !!}
    {!! Form::select('province_code', @$provinces,null, ['class' => 'form-control select2']) !!}
</div>

<!-- City Name Field -->
<div class="form-group col-sm-6">
    {!! Form::label('city_name', 'City Name:', ['class' => 'd-block']) !!}
    {!! Form::text('city_name', null, ['class' => 'form-control']) !!}
</div>

<!-- Icon Map Field -->
{{-- <div class="form-group col-sm-6">
    {!! Form::label('icon_map', 'Icon Map:', ['class' => 'd-block']) !!}
    {!! Form::file('icon_map', ['class' => 'dropify','id' => 'input-file-now', 'data-default-file' => @$city->icon_map ? asset($city->icon_map) : '', 'data-allowed-file-extensions' => 'jpg jpeg png', 'data-max-file-size' => '1M']) !!}
</div> --}}
...
<div class="form-group col-sm-12">
    <div class="row">
        <div class="col-6">
            {!! Form::label('icon_map_blue', 'Icon Map Blue:', ['class' => 'd-block']) !!}
        ...
        <div class="col-6">
            {!! Form::label('icon_map_green', 'Icon Map Green:', ['class' => 'd-block']) !!}
